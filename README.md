...
Open bitirme_projesi.ipynb or ship_detecton_v1.ipynb in Google Colab.

Link the best.pt file from the demo_output or ship_detection_v1 folder to run the model on your own images.
